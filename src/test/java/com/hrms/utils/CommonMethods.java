...
public class CommonMethods extends PageInitializer {
	...
	public static void sendTextAndHitEnter(WebElement element, String text) {
		waitForVisibility(element);
		element.clear();
...
//====================================================================================================================
	...
	public static boolean presenseTextInTable(String requiredЕext, List<WebElement> rows) {
